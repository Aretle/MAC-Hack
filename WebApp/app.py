...
def admin():
    ...
    return render_template('admin.html', clients=clients, client_interests=client_interests, client_goals=client_goals, special_needs=special_needs, client_special_needs=client_special_needs, rosters=rosters, tasks=tasks, appointments=appointments, contacts=contacts, communications=communications)
